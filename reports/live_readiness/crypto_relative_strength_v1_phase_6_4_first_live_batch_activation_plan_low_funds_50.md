...
- Generated at: `2026-04-28T02:13:17.707931+00:00`
...
- `PASS` Batch order count is capped: max_batch_orders=1; allowed_pairs=2.
- `PASS` Batch notional is inside gross risk limit: max_batch_notional=50; max_gross_notional=1000.
...
5. Cap the batch to 1 order(s) and 50 USDT total notional.
