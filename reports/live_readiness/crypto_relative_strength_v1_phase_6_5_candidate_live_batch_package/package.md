...
- Generated at: `2026-04-28T02:09:39.977300+00:00`
- Decision: `live_batch_execution_package_ready_pending_exchange_state_check`
- Session id: `crypto_relative_strength_v1_phase_6_5_candidate_live_batch_package`
...
| --- | --- | --- | --- | --- | --- | --- |
| `crypto_relative_strength_v1_first_live_batch_001-btc_usdt-1` | `BTC-USDT` | `buy` | `250` | `0.003231171446990952202960993815` | `77371.32000000` | `0.034237807009464912373334096` |
...
- `PASS` Candidate order count is inside batch cap: orders=1; cap=2.
- `PASS` Candidate order notionals are inside single-order cap: single_order_cap=250.
- `PASS` Candidate batch notional is inside batch cap: total_notional=250; cap=500.
...
- candidate_orders_jsonl: `reports/live_readiness/crypto_relative_strength_v1_phase_6_5_candidate_live_batch_package/candidate_orders.jsonl`
- package_json: `reports/live_readiness/crypto_relative_strength_v1_phase_6_5_candidate_live_batch_package/package.json`
- package_md: `reports/live_readiness/crypto_relative_strength_v1_phase_6_5_candidate_live_batch_package/package.md`
